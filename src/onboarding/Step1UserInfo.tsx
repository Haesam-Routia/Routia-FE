...
import { TextField, ChipSelect, GenderSelect, RegionSelect, OnboardingShell, type RegionValue } from "../components/onboarding";
...
export default function Step1UserInfo() {
  ...
  return (
    <OnboardingShell
      step={1}
      eyebrow="피부 프로필 만들기"
      title={<>사용자 정보를<br/>입력해주세요</>}
      subtitle={<>개인 맞춤 루틴 추천을 위해 신체 정보를 입력해주세요. <b className="text-ob-ink font-bold">*</b> 표시는 필수 항목이에요.</>}
    ...
    >
      ...
      <div className="bg-ob-surface border border-ob-border rounded-ob-lg p-5 shadow-ob-card">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 rounded-[11px] bg-gradient-to-br from-ob-primary-softer to-ob-primary-soft flex items-center justify-center shrink-0">
            <svg className="w-4 h-4 stroke-ob-primary-deep" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M2 12h20"/></svg>
          </div>
          <div>
            <p className="text-[15.5px] font-extrabold text-ob-ink">신체 정보</p>
            <p className="text-[11.8px] text-ob-ink-faint font-semibold">키와 몸무게를 입력해주세요</p>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          <TextField label="키" placeholder="165.5 cm" value={form.height} onChange={set("height")} fullWidth />
          <TextField label="몸무게" placeholder="55.5 kg" value={form.weight} onChange={set("weight")} fullWidth />
        </div>
      </div>
      ...
      <div className="bg-ob-surface border border-ob-border rounded-ob-lg p-5 shadow-ob-card">
        <div className="flex items-center gap-3 mb-1">
          <div className="w-8 h-8 rounded-[11px] bg-gradient-to-br from-ob-primary-softer to-ob-primary-soft flex items-center justify-center shrink-0">
            <svg className="w-4 h-4 stroke-ob-primary-deep" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
          </div>
          <div>
      ...
      <div className="bg-ob-surface border border-ob-border rounded-ob-lg p-5 shadow-ob-card">
        <div className="flex items-center gap-3 mb-1">
          <div className="w-8 h-8 rounded-[11px] bg-gradient-to-br from-ob-primary-softer to-ob-primary-soft flex items-center justify-center shrink-0">
            <svg className="w-4 h-4 stroke-ob-primary-deep" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>
          </div>
          <div>
      ...
      <div className="bg-ob-surface border border-ob-border rounded-ob-lg p-5 shadow-ob-card">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-[11.8px] text-ob-ink-faint font-semibold">맞춤 서비스를 위한 지역 정보</p>
          </div>
        </div>
