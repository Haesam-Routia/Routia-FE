        ...
        <div className="flex flex-1 items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-subtextColor">{weather.condition}</span>
            </div>
            {/* 체감 8px / 600 */}
            <div className="mt-0.5 text-[8px] font-semibold text-subtextColor">체감 {weather.feelsLike}°C</div>
          </div>
        </div>
        ...
        <div className="flex flex-1 items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[10px] text-subtextColor">{weather.uvLevel}</span>
            </div>
            ...
            <div className="mt-0.5">
              {weather.uvDesc.split("\n").map((line, i) => (
                <div
                  key={i}
                  className={`font-medium text-subtextColor ${i === 0 ? "text-[8px]" : "text-[7px]"}`}
                >
                  {line}
                </div>
              ))}
