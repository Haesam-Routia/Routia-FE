  ...
  return (
    <div className="absolute left-1/2 top-[30px] z-30 flex h-[656px] w-[362px] -translate-x-1/2 flex-col rounded-xl border border-lineColor bg-white pb-[28px] pt-[21px]">
      ...
      <button
        type="button"
        onClick={onClose}
        className="mx-auto mt-auto flex h-[50px] w-[202px] items-center justify-center rounded-xl bg-buttonColor px-4 py-3.5 text-sm font-semibold text-white transition-all duration-200 active:scale-[0.98]"
      >
        닫기
      </button>
    </div>
