        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => toggle(opt)}
              className={`rounded-full border-[1.5px] text-[13.5px] font-bold whitespace-nowrap transition-all duration-150 flex items-center justify-center gap-1.5 ${itemClassName} ${
                selected
